                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">{$titreVue}
                        ...
                        <div class="card-body">
                            <div{if produitTable::getMessageSucces() neq ''} class="alert alert-success"
                                                                            role="alert">{/if}
                                {produitTable::getMessageSucces()}
                            </div>
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                {foreach from=$listeProduits item=unProduit}
                                    <tr>
                                        <td>{$unProduit->getReference()}</td>
                                        <td>{$unProduit->getDesignation()}</td>
                                        <td>{$unProduit->getPrix_unitaire_HT()}</td>
                                        <td>{$unProduit->getStock()}</td>
