                            ...
                            <div class="card-body card-block">
                                {if $action neq 'ajouter'}
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               name="codec" class="form-control" value="{$unClient->getCodec()}"
                                               readonly>
                                    </div>
                                {/if}
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           name="nom" class="form-control" value="{$unClient->getNom()}"
                                            {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           name="adresse" class="form-control" value="{$unClient->getAdresse()}"
                                            {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           name="telephone" class="form-control" value="{$unClient->getTelephone()}"
                                            {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           name="cp" class="form-control" value="{$unClient->getCp()}"
                                            {$readonly}>
                                </div>
                                ...
                                {if $action neq 'modifier' || 'ajouter'}
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{$unClient->getDesignations()}" {$readonly}>
                                    </div>
                                {/if}
{*                                <div class="form-group">*}
{*                                    <select multiple>*}
